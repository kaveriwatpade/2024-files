...
router.post('/partnerCompanyList1', authenticationHelpers.isEslAuth, function(req, res){
	//console.log(req.body,'pppppppppppppppppppppppppppp')
	company.partnerCompanyList1(req.body,function(err, result){
		// console.log(result,'resultttttt 300');
		if (err) { 
			res.json({"error" : true,"reason": "Error: Something went wrong. Please try again!"}); 
			return res;
		}
...
//start salim
router.post("/updateLicenseDetails", authenticationHelpers.isEslAuth, function (req, res) {
...
router.post("/simManage", authenticationHelpers.isEslAuth, function (req, res) {
...
router.post("/getwayList", authenticationHelpers.isEslAuth, function(req,res){
