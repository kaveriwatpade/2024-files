...
router.post('/submitBasic', authenticationHelpers.isAdminAuth, function (req, res) {
...
router.post('/submitSecurity', authenticationHelpers.isAdminAuth, function (req, res) {
...
router.post('/submitRegional', authenticationHelpers.isAdminAuth, function (req, res) {
  ...
  var errorMsg = '';
    ...
    profile.submitRegional(req.body, req.session.passport.user.user_id,function (err) {
      if (err) {
        res.json({ "error": true, "reason": "Error: Something went wrong. Please try again!" });
        return res;
      }
...
router.post('/timezone', authenticationHelpers.isAdminAuth, function (req, res) {
