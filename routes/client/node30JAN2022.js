...
console.log(data,'data!!!!!!!!!!!!')
    ...
    logic.getNodesMapping(req.body,function(logicErr,logicResult){
      if(logicErr){
        console.log(logicErr,'errror!!!!!!!!!!!!!err107',req.body,logicResult)
    ...
    node.nodeData(req.body, function (err, result) {
      if (err) {
        console.log(err,'errror!!!!!!!!!!!!!err107',req.body,result)
        res.json({ "error": true, "reason": "Error: Something went wrong. Please try again!" });
        return res;
      }
      if (!result) {
      ...
      console.log(result,'errror!!!!!!!!!!!!!result',logicResult)
...
//  console.log(JSON.parse(req.body['nodeDataSettings']),'json');
